...
public class ImageController {
    ...
    //getting the images based on the Id then the name which prevents the breaking when duplicates are present
    ...
    //Redirects to images/edit if the user has the permission to edit else show appropriate error message.
    ...
    //Redirects to images if sucessfully deleted or if the user does not have the permission to delete then show appropriate message.
